...
<head>
	<meta charset="UTF-8">
	<title>Computer mobile and shop management system</title>
...
<!--Start faq single area-->
<section class="faq-single-area">
    <div class="container">
        <div class="row">
                ...
                <div class="content-box">
                    <div class="accordion-box">
                        ...
                        <div class="accordion accordion-block">
                            <div class="accord-btn"><h4>Will my repair cause data loss on my device?</h4></div>
                        ...
                        <!--Start single accordion box-->
                        <div class="accordion accordion-block">
                            <div class="accord-btn active"><h4>Do you provide any guarantee on the repairs?</h4></div>
                        ...
                        <!--Start single accordion box-->
                        <div class="accordion accordion-block">
                            <div class="accord-btn"><h4>What is the procedure for getting phone unlocked?</h4></div>
                            <div class="accord-content">
                                <p>We give a Guarantee for a Period of 5 years and promise to rectify any fault arising out of faulty workmanship at our cost. However the guarantee does not hold good for mishandling and breakable items.</p>
                            </div>
                        </div>
                        ...
                        <!--Start single accordion box-->
                        <div class="accordion accordion-block">
                            <div class="accord-btn"><h4>How will I get the updates of my repairs?</h4></div>
                            <div class="accord-content">
                                <p>We give a Guarantee for a Period of 5 years and promise to rectify any fault arising out of faulty workmanship at our cost. However the guarantee does not hold good for mishandling and breakable items.</p>
                            </div>
                        </div>
                        ...
                        <!--Start single accordion box-->
                        <div class="accordion accordion-block">
                            <div class="accord-btn"><h4>What if you find more problems than quoted?</h4></div>
                            <div class="accord-content">
                                <p>We give a Guarantee for a Period of 5 years and promise to rectify any fault arising out of faulty workmanship at our cost. However the guarantee does not hold good for mishandling and breakable items.</p>
                            </div>
                        </div>
                        ...
                        <!--Start single accordion box-->
                        <div class="accordion accordion-block">
                            <div class="accord-btn"><h4>Whom to contact in case of any grievances</h4></div>
                            <div class="accord-content">
                                <p>We give a Guarantee for a Period of 5 years and promise to rectify any fault arising out of faulty workmanship at our cost. However the guarantee does not hold good for mishandling and breakable items.</p>
                            </div>
                        </div>
