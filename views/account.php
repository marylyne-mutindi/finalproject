...
<head>
	<meta charset="UTF-8">
	<title>computer shop and mobile repair management system</title>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <button class="thm-btn bg-1" type="submit">Login Now</button>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-lg-5 col-md-3 col-sm-4 col-xs-12">
                                        <button class="thm-btn bg-1" type="submit">Register Here</button>
                                    </div>
...
<!-- Mirrored from st.ourhtmldemo.com/new/RepairPlus/account.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jun 2022 13:58:10 GMT -->
</html>