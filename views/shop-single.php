                        ...
                        <div class="col-md-6">
                            <div class="content-box">
                                ...
                                <div class="addto-cart-box">
                                    ...
                                    <button class="thm-btn bg-1 addtocart" type="submit">Add to Cart</button>
                                </div>    
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="product-tab-box">
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="add-rating-box">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <i class="fa fa-star"></i>
                                                        ss="thm-btn bg-1" href="shop-single.html">Add to Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="title-hold            <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                                                    </a>
                                                </li>
                                                <li>
                                ...
                                <div class="title-hold        </div>
                                        ...
                                        </foss="thm-btn bg-1" href="shop-single.html">Add to Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="title-holdrm>  
                                    </div>
                                </div>
                            </div>      
                        </div>
                    </div>ss="thm-btn bg-1" href="shop-single.html">Add to Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="title-holde-product-item">
                                <div class="img-holder">
                                    <img src="../images/shop/1.jpg" alt="Awesome Product Image">
                                    <div class="overlay-box">
                                        <div class="box">
                                            <div class="content">
                                                <a class="thm-btn bg-1" href="shop-single.html">Add to Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12">
                            <div class="single-footer-widget">
                                ...
                                <ul class="services-list">
                                    ...
                                    <li><a href="desktop-repair.phpp">Desktop & Laptop</a></li>
            ...
            <div class="col-md-12">
                <div class="footer-bottom">
                    <div class="copyright-text pull-left">
                        <p>Copyrights @marylynemutindimutindi <a href="#"></a></p> 
                    </div>
