            ...
            <div class="col-md-6 col-sm-8 col-xs-12">
                <div class="apply-coupon">
                    ...
                    <div class="apply-coupon-button">
                        <button class="thm-btn bg-1" type="button">Apply Coupon</button>
                    </div>        
                </div>
            </div>
            <div class="col-md-6 col-sm-4 col-xs-12">
                <div class="update-cart pull-right">
                    <button class="thm-btn bg-1" type="button">Update Cart</button>
                </div>
            </div>
        </div>
        <div class="row cart-bottom">
            <div class="col-md-6">
                <div class="calculate-shipping">
				    ...
				    <button class="thm-btn bg-1" type="submit">update Totals</button> 
                </div>
            </div>
            <!--Start cart total -->
            <div class="col-lg-6 col-md-6">
                <div class="cart-total">
                    ...
                    <button class="thm-btn bg-1 checkout-btn">Proceed to Checkout</button> 
                </div>    
            </div>
            <!--End cart total -->
        </div>
...
<!-- Mirrored from st.ourhtmldemo.com/new/RepairPlus/shopping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jun 2022 13:58:10 GMT -->
</html>