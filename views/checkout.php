        ...
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="form billing-info">
                    ...
                    <form method="post" action="http://st.ourhtmldemo.com/new/RepairPlus/checkout.html">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="cart-total">
                    ...
                    <div class="payment-options">
                        ...
                        <div class="placeorder-button text-left">
                            <button class="thm-btn bg-1" type="submit">Place Order</button>
                        </div>   
                    </div>          
                </div>    
            </div>
...
<!-- Mirrored from st.ourhtmldemo.com/new/RepairPlus/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jun 2022 13:58:10 GMT -->
</html>