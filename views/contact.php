        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="contact-form">
                    ...
                    <form id="contact-form" name="contact_form" class="default-form" action="http://st.ourhtmldemo.com/new/RepairPlus/inc/sendmail.php" method="post">
                        <div class="row">
                            <div class="col-md-6">
...
<!-- Mirrored from st.ourhtmldemo.com/new/RepairPlus/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jun 2022 13:58:44 GMT -->
</html>