                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="single-item">
                                ...
                                <div class="text">
                                    <p>The master-builder human happiness one rejects, dislikesavoided pleasure itself, because it is pleasure, but because those who do not know how to pursue pleasure rationally encounter.</p>
                                    <a href="#">View Questions<i class="fa fa-caret-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                        <!--End single item-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="single-item">
                                ...
                                <div class="text">
                                    <p>Complete account the system, and expound the actual teachings of the great explorer of the truth, the master-builder workers of human happiness encounter consequences. </p>
                                    <a href="#">View Questions<i class="fa fa-caret-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <div class="footer-bottom">
                    <div class="copyright-text pull-left">
                        <p>Copyrights @marylymemutindi <a href="#"></a></p> 
                    </div>
